...
const Navbar = ({ isDarkMode, setIsDarkMode }) => {
  ...
  return (
    <>
      <div className="fixed top-0 right-0 w-11/2 -z-10 translate-y-[-80%] dark:hidden">
      ...
      >
        ...
        <ul
          className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 text-gray-700 font-medium ${
            isScroll ? "" : "bg-white shadow-md bg-opacity-50"
          }`}
        >
          <li>
