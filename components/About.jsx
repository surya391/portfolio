      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <ul className="flex items-center gap-3 sm:gap-5">
            ...
            toolsData.map((tool,index)=>(
                <li className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer " key={index}><Image src={tool} alt='Tool' className="w-5 sm:w-7 "/></li>
            ))
          }
        </ul>
        </div>
